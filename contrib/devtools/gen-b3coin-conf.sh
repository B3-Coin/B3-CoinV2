...
BITCOIND=${BITCOIND:-$BINDIR/b3coind}
SHARE_EXAMPLES_DIR=${SHARE_EXAMPLES_DIR:-$TOPDIR/share/examples}
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/b3coin.conf}
...
then
  ...
  echo -e "To safely generate a b3coin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example b3coin.conf file in share/examples/'
...
##
## b3coin.conf configuration file.
## Generated by contrib/devtools/gen-b3coin-conf.sh.
##
