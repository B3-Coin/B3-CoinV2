...
(
    ...
    case "$HOST" in
        *mingw*)
            ...
            mv build/b3coin-win64-setup.exe "${OUTDIR}/${DISTNAME}-win64-setup-unsigned.exe"
            ;;
    esac
    ...
    (
        ...
        cp "${DISTSRC}/share/examples/b3coin.conf" "${DISTNAME}/"
    ...
    case "$HOST" in
        ...
        *darwin*)
            ...
            mv build/dist/b3coin-macos-app.zip "${OUTDIR}/${DISTNAME}-${HOST}-unsigned.zip"
