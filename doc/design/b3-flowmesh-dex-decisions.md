...
| L-6 | **FlowMesh's first dollar asset is bridge-backed bUSD: exact 1:1 USDT raw units proven locked on Ethereum mainnet mint the B3 `BRIDGE_BACKED` asset** (owner supersession 2026-09-01). The first registry tuple pins chain id 1, vault `0x143F207e23e6aebD7E974be90ac6D434f4c7BFb6`, canonical USDT `0xdAC17F958D2ee523a2206206994597C13D831ec7`, and 6 decimals. | The earlier native CDP/oracle proposal is historical and not a release dependency. The ticker alone authorizes nothing; the full ACTIVE registry tuple and bridge proof gates are mandatory. |
