...
| L-6 | **FlowMesh's first dollar asset is bridge-backed bUSD: exact 1:1 USDT raw units proven locked on Ethereum mainnet may mint the B3 `BRIDGE_BACKED` asset only after separate bridge activation** (owner supersession 2026-09-01). The first registry tuple pins chain id 1, vault `0x143F207e23e6aebD7E974be90ac6D434f4c7BFb6`, canonical USDT `0xdAC17F958D2ee523a2206206994597C13D831ec7`, and 6 decimals. | The bounded type-10 proof/mint/burn path, exact OWNER mint, exact bUSD BURN request, nullifier/caps, undo/reindex replay, and mempool/miner/asset integration are implemented. State is rebuilt in memory and configured bridge nodes refuse pruning because no durable sidecar exists. Adapter enforcement, operator release automation/consumption storage, audits, and production pins remain gates. The ticker alone authorizes nothing and A3 never activates the bridge. |
