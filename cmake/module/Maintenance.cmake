...
function(add_windows_deploy_target)
  if(MINGW AND TARGET b3coin-qt AND TARGET b3coind AND TARGET b3coin-cli AND TARGET b3coin-tx AND TARGET b3coin-wallet AND TARGET b3coin-util AND TARGET test_bitcoin)
    ...
    add_custom_command(
      ...
      COMMAND ${CMAKE_STRIP} $<TARGET_FILE:b3coin-cli> -o ${PROJECT_BINARY_DIR}/release/$<TARGET_FILE_NAME:b3coin-cli>
...
function(add_macos_deploy_target)
  if(CMAKE_SYSTEM_NAME STREQUAL "Darwin" AND TARGET b3coin-qt)
    ...
    add_custom_command(
      OUTPUT ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/b3coin-qt
      COMMAND ${CMAKE_COMMAND} --install ${PROJECT_BINARY_DIR} --config $<CONFIG> --component b3coin-qt --prefix ${macos_app}/Contents/MacOS --strip
    ...
    set(macos_zip "b3coin-macos-app")
    if(CMAKE_HOST_APPLE)
      add_custom_command(
        ...
        DEPENDS ${PROJECT_BINARY_DIR}/${macos_app}/Contents/MacOS/b3coin-qt
        VERBATIM
      )
      ...
      add_custom_command(
        OUTPUT ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/b3coin-qt
      ...
      add_custom_target(deploydir
        DEPENDS ${PROJECT_BINARY_DIR}/dist/${macos_app}/Contents/MacOS/b3coin-qt
      )
    ...
    add_dependencies(deploydir b3coin-qt)
