...
static RPCHelpMan waitfornewblock()
{
    return RPCHelpMan{
        ...
        "Waits for any new block and returns useful info about it.\n"
                ...
                "\nMake sure to use no RPC timeout (b3coin-cli -rpcclienttimeout=0)",
                {
...
static RPCHelpMan scanblocks()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. Make sure to use no RPC timeout (b3coin-cli -rpcclienttimeout=0)",
        {
            scan_action_arg_desc,
            scan_objects_arg_desc,
...
static RPCHelpMan getdescriptoractivity()
{
    return RPCHelpMan{
        ...
        "This call may take several minutes. If you encounter timeouts, try specifying no RPC timeout (b3coin-cli -rpcclienttimeout=0)",
        {
