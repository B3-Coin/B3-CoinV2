...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "issueasset", 0, "max_supply" },
    { "issueasset", 1, "decimals" },
    { "issueasset", 2, "address", ParamFormat::STRING },
    { "issueasset", 3, "options" },
    { "getwalletassets", 0, "asset_id", ParamFormat::STRING },
    { "getwalletassets", 1, "minconf" },
    { "getwalletassets", 2, "include_unsafe" },
    { "setassetmetadata", 0, "asset_id", ParamFormat::STRING },
    { "setassetmetadata", 1, "name", ParamFormat::STRING },
    { "setassetmetadata", 2, "ticker", ParamFormat::STRING },
    { "setassetmetadata", 3, "issuance_hex", ParamFormat::STRING },
    { "clearassetmetadata", 0, "asset_id", ParamFormat::STRING },
    { "sendasset", 0, "asset_id", ParamFormat::STRING },
    { "sendasset", 1, "amount" },
    { "sendasset", 2, "address", ParamFormat::STRING },
    { "sendasset", 3, "options" },
    { "burnasset", 0, "asset_id", ParamFormat::STRING },
    { "burnasset", 1, "amount" },
    { "burnasset", 2, "options" },
    { "createfncoin", 0, "address", ParamFormat::STRING },
    ...
    { "submitflowmeshdeposit", 0, "market_id", ParamFormat::STRING },
    { "submitflowmeshdeposit", 1, "txid", ParamFormat::STRING },
    { "submitflowmeshdeposit", 2, "vout" },
    { "submitflowmeshorder", 0, "market_id", ParamFormat::STRING },
    { "submitflowmeshorder", 1, "side", ParamFormat::STRING },
    { "submitflowmeshorder", 2, "price" },
    { "submitflowmeshorder", 3, "quantity" },
    { "submitflowmeshorder", 4, "sequence" },
    { "cancelflowmeshorder", 0, "market_id", ParamFormat::STRING },
    { "cancelflowmeshorder", 1, "side", ParamFormat::STRING },
    { "cancelflowmeshorder", 2, "sequence" },
    { "requestflowmeshwithdrawal", 0, "market_id", ParamFormat::STRING },
    { "requestflowmeshwithdrawal", 1, "asset", ParamFormat::STRING },
    { "requestflowmeshwithdrawal", 2, "amount" },
    { "requestflowmeshwithdrawal", 3, "destination", ParamFormat::STRING },
    { "requestflowmeshwithdrawal", 4, "sequence" },
    ...
    { "createflowmeshvaulttx", 2, "options" },
    { "startflowmeshvalidator", 0, "expected_armed_keys_fingerprint", ParamFormat::STRING },
    { "stopflowmeshvalidator", 0, "expected_armed_keys_fingerprint", ParamFormat::STRING },
    ...
    { "getbridgeanchorforblock", 0, "target_block" },
    { "getbridgeproofstatus", 1, "deposit_id" },
    { "bridgewithdraw", 0, "amount" },
    { "bridgewithdraw", 1, "ethereum_recipient", ParamFormat::STRING },
    { "bridgewithdraw", 2, "options" },
    { "getbridgefinalityproof", 0, "hash_or_height", ParamFormat::JSON_OR_STRING },
    { "getbridgewithdrawalproof", 0, "txid", ParamFormat::STRING },
    { "getbridgewithdrawalproof", 1, "burn_vout" },
    { "getbridgewithdrawalproof", 2, "certificate_block", ParamFormat::JSON_OR_STRING },
    { "getfinalityset", 0, "epoch" },
    { "getfinalityset", 1, "offset" },
    { "getfinalityset", 2, "count" },
    { "signbridgebootstrap", 1, "binding_seq" },
