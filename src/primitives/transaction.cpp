...
CMutableTransaction::CMutableTransaction(const CTransaction& tx) : vin(tx.vin), vout(tx.vout), version{tx.version}, nTime{tx.nTime}, nLockTime{tx.nLockTime}, mpa(tx.mpa), m_legacy_encoding{tx.IsLegacyEncoded()} {}
