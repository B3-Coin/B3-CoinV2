...
void BitcoinGUI::createActions()
{
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your B3 addresses to prove you own them"));
    verifyMessageAction = new QAction(tr("&Verify message…"), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified B3 addresses"));
    ...
    openAction->setStatusTip(tr("Open a b3coin: URI"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to list available B3 command-line options").arg(HIVE_NAME));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to the B3 FlowMesh network.", "", count);
    } else {
        //: A substring of the tooltip.
