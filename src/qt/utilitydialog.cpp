    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = QString{HIVE_NAME} + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());

    if (about)
    {
        setWindowTitle(tr("About %1").arg(HIVE_NAME));
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("%1 is shutting down…").arg(HIVE_NAME) + "<br /><br />" +
