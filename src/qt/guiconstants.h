...
#define QAPP_APP_NAME_TESTNET "B3Coin-Core-testnet"
#define QAPP_APP_NAME_TESTNET4 "B3Coin-Core-testnet4"
#define QAPP_APP_NAME_SIGNET "B3Coin-Core-signet"
#define QAPP_APP_NAME_REGTEST "B3Coin-Core-regtest"
