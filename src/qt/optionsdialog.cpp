      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->externalSignerPath->setToolTip(ui->externalSignerPath->toolTip().arg(HIVE_NAME));
#else
    ...
    ui->bitcoinAtStartup->setToolTip(ui->bitcoinAtStartup->toolTip().arg(HIVE_NAME));
    ui->bitcoinAtStartup->setText(ui->bitcoinAtStartup->text().arg(HIVE_NAME));

    ui->openBitcoinConfButton->setToolTip(ui->openBitcoinConfButton->toolTip().arg(HIVE_NAME));

    ui->lang->setToolTip(ui->lang->toolTip().arg(HIVE_NAME));
