...
void SetupChainParamsBaseOptions(ArgsManager& argsman)
{
    ...
    for (const char* knob : {"-b3corridorlength", "-b3corridorspacing", "-b3corridorreward", "-b3blockinterval", "-b3roundseconds", "-b3epochlength", "-b3checkpointinterval", "-b3checkpointdepth", "-b3maxepochextension", "-b3minfinalityset", "-b3reorghorizon", "-b3minstake"}) {
