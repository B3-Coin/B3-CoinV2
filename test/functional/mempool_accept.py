...
class MempoolAcceptanceTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.mempool_size = 0
        # Also check feerate. 1 B3/kvB fails.
        assert_raises_rpc_error(-8, "Fee rates larger than or equal to 1 B3/kvB are not accepted", lambda: self.check_mempool_result(
